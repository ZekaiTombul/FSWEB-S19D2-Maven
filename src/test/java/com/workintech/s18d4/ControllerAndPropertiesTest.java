...
class ControllerAndPropertiesTest {
    ...
    void testFindAllAccount() throws Exception {
        ...
        mockMvc.perform(get("/account"))
                ...
                .andExpect(jsonPath("$[0].id", is(Math.toIntExact(sampleAccountForAccountControllerTest.getId()))))
    ...
    void testFindAccount() throws Exception {
        ...
        mockMvc.perform(get("/account/{id}", sampleAccountForAccountControllerTest.getId()))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.id", is(Math.toIntExact(sampleAccountForAccountControllerTest.getId()))))
    ...
    void testUpdateAccount() throws Exception {
        ...
        mockMvc.perform(put("/account/{customerId}", customerId)
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id", is(Math.toIntExact(updatedAccount.getId()))))
    ...
    void testSaveCustomer() throws Exception {
        ...
        mockMvc.perform(post("/customer")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id", is(Math.toIntExact(expectedResponse.id()))))
